...
```javascript
iterLog1pexp = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-log1pexp@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-log1pexp/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/math-iter-special-log1pexp/actions/workflows/test.yml?query=branch:v0.2.1
